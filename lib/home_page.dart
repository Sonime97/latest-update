...
// ),
        ...
        body: FutureBuilder<List<Map>>(
            ...
            //  Scaffold.of(context).openDrawer();
                    ...
                    elevation: 0,
                    floating:
                        true, // Makes the app bar disappear when scrolling down
                    pinned:
                        false, // Keeps the app bar hidden when scrolling down
                    actions: [
                      Container(
                                  ...
                                  itemBuilder:
                                    ...
                                    return Container(
                                      ...
                                      width: MediaQuery.of(context).size.width /
                                          3, // Adjust the width of the container to control the card size
                  ...
                  SliverToBoxAdapter(
                      child: Padding(
                          ...
                          child: Container(
                              height:
                                  200.0, // Set the height of the horizontal GridView
                              child: GridView.builder(
                                  ...
                                  gridDelegate:
                                    ...
                                    crossAxisCount:
                                        1, // Adjust this value based on your desired number of items in a row
                                    childAspectRatio: 0.9,
                                    crossAxisSpacing:
                                        10.0, // Add spacing between adjacent grids
                                    ...
                                    return Stack(
                                      children: [
                                        ...
                                        Positioned(
                                          bottom: 0,
                                          left:
                                              0, // Adjust the alignment as needed
                                          right:
                                              0, // Adjust the alignment as needed
                                          child: Container(
